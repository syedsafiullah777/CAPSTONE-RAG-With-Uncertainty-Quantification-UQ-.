...
**Decision:** Keep an authoritative chronology at `V2/project_record/PROJECT_MASTER_RECORD.md` and update it after every completed phase.
...
**Docs:** `docs/storage_backup_recovery.md`, `docs/IMPLEMENTATION_PLAN.md`, config `storage` section.
