...
**Phase 20 (final examiner demo):** the Streamlit app now always uses **locked T=0.65**. Sidebar pages: Live RAG Demo, Benchmark Results, Benchmark Questions. UQ may show a UI-only moderate-confidence caption near T; it does not change the research ANSWER/ABSTAIN rule. See `docs/phase20_live_artefact.md`. Do not treat Phase 11 smoke 0.55 runs as the final live artefact.
